...
/**
 * RegisterCustomerOffer represents the model behind the search form about `backend\modules\customer\models\RegisterCustomer`.
 */
class RegisterCustomerOffer extends RegisterCustomer {
