...
$this->title = Yii::t('person', 'ข้อมูลประวัติส่วนตัว-สมัครสมาชิก');
...
<div class="box">
    ...
    <div class="box-body">
        ...
        <?= Html::tag('h4', '1. ' . Yii::t('person', 'ข้อมูลประวัติส่วนตัว')); ?>
...
//                        'layout' => 'horizontal'
            ...
            <div class="col-sm-11 col-sm-offset-1">
                ...
                <div class="row">
                    <div class="col-sm-3">                
                        <?= $form->field($model, 'sex')->inline()->radioList(Person::getItemSex()) ?>
                    </div>
                    <div class="col-sm-3">    
                        <?=
