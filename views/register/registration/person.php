...
<div class="row">
    <div class="col-sm-3 col-sm-offset-2">
        <?php
        if ($modelPerson->birthday) {
            $modelPerson->birthday = date('d/m/Y', strtotime($modelPerson->birthday));
        }
        ?>
        <?=
...
<div class="row">
    ...
    <div class="col-sm-3">
        <?php
        if ($modelPersonDetail->date_of_issue) {
            $modelPersonDetail->date_of_issue = date('d/m/Y', strtotime($modelPersonDetail->date_of_issue));
        }
        ?>
        <?=
    ...
    <div class="col-sm-3">
        <?php
        if ($modelPersonDetail->date_of_expiry) {
            $modelPersonDetail->date_of_expiry = date('d/m/Y', strtotime($modelPersonDetail->date_of_expiry));
        }
        ?>
        <?=
